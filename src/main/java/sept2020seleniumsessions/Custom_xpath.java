...
public class Custom_xpath {public static void main(String[] args) {
...
//	<input id = test_890>
	...
	//a[text()='abhishek']//parent::td//preceding-sibling::td/input[@type='checkbox']
	//a[text()=('Aaa Chhii')]//parent::td//preceding-sibling::td/input[@type='checkbox']
